...
extern "C" {
	...
	PYMORT_DLL_API void LiteMORT_fit_1(void *, PY_DATASET_LIST *train, PY_DATASET_LIST *eval, PY_DATASET_LIST *merge, size_t flag);
	//PYMORT_DLL_API void LiteMORT_predict_1(void *, PY_COLUMN *X, PY_COLUMN *y, size_t nFeat_0,size_t nSamp,  size_t flag);
	PYMORT_DLL_API void LiteMORT_predict_1(void *, PY_DATASET_LIST*predict, PY_DATASET_LIST *merge, size_t flag);
