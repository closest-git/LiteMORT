...
setup(
    ...
    version='0.1',
    author='Yingshi Chen',
    author_email='gsp.cys@gmail.com',
    description='Ultra-fast gradient boosting library for regression,classification and more',
    long_description='',
    packages=find_packages('src'),
    package_dir={'':'src'},
    ext_modules=[CMakeExtension('LiteMORT/LiteMORT')],
